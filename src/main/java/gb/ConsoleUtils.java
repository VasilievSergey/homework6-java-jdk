...
public class ConsoleUtils {
    ...
    public static Integer getUserInputIntRange(Scanner inputScanner, String prompt, Integer min, Integer max) {
    ...
    public static Integer getUserInputInt(Scanner inputScanner, String prompt, Function<Integer, Boolean> checkIfValid,
    ...
    public static Optional<LocalDate> askDate(String prompt) {
        while (true) {
            var strDate = askString(prompt, s -> s.matches("^\\d{4}-\\d{2}-\\d{2}$"), ERR_WRONG_DATE_FORMAT);
            if (strDate.isEmpty()) {
    ...
    public static String getUserInput(Scanner inputScanner, String prompt, Function<String, Boolean> checkIfValid,
                                      String wrongWarn) {
        boolean wrong = false;
        while (true) {
            if (wrong) {
